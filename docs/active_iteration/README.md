...
| CRU-1 至 CRU-7 累积开发版 | [CRU_1_TO_7_DEVELOPMENT_RELEASE.md](./CRU_1_TO_7_DEVELOPMENT_RELEASE.md) | `0.1.0.dev4` 的完整范围、typed pre-task admission、CRU-7 默认开关、联网加固、验证与回滚边界 |
