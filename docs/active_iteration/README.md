...
recovery、CRU-5 core active diagnostic strengthening 与 CRU-6 verified core/post-core
handoff 已完成；下一阶段是 CRU-7 canary/default switch。post-core transaction 仍等待
权威 post-core PKG3/PKG4 consumer，不回落 legacy improvement loop。
