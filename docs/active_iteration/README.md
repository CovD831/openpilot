...
| CRU-1 至 CRU-7 累积开发版 | [CRU_1_TO_7_DEVELOPMENT_RELEASE.md](./CRU_1_TO_7_DEVELOPMENT_RELEASE.md) | `0.1.0.dev5` 的完整范围、safe project scope、bounded inventory、typed pre-task admission、验证与回滚边界 |
